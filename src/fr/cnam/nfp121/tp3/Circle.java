...
public class Circle {
     ...
     */
    public Circle(Point a_center, double a_radius) {
     ...
     */
    public Circle(Point a_pd1, Point a_pd2, Color a_color) {
     ...
     * @param a_pd2 : le Point diametral 2
     */
    public Circle(Point a_pd1, Point a_pd2) {
    ...
    public static Circle createCircle(Point a_pCenter, Point a_pc) {
     ...
     */
    public Boolean contains(Point a_p) {
